"""
Django settings for cdfhh_19 project.
...
WSGI_APPLICATION = 'cdfhh_19.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cdfhh_19 API",
    "DESCRIPTION": "API documentation for cdfhh_19 App",
    "VERSION": "v1",
}
